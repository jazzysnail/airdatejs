...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utl2 = __webpack_require__(6);

	var _utl3 = _interopRequireDefault(_utl2);

	var _class2 = __webpack_require__(7);
	...
	var lib = {
	  _utl: _utl3.default,
	  _class: _class3.default,
	  _style: _style3.default
	};
	...
	var _class = {
	  ...
	  */
	  add: function add(ele, cls) {
	    ...
	    ele.className = _utl3.default.trim(ele.className);
	    return this;
	  },
